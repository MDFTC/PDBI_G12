...
## Propuesta
El proyecto propone el desarrollo de un sistema portátil y no invasivo para la evaluación preliminar de lesiones melanocíticas mediante la captura de imágenes RGB y el uso de técnicas de procesamiento digital de imágenes y aprendizaje automático.

El sistema busca adquirir imágenes de lesiones cutáneas bajo condiciones de captura estandarizadas, permitiendo analizar características visuales como la forma, los bordes, la coloración y otros patrones morfológicos relevantes. A partir de estas imágenes, se plantea implementar un modelo de aprendizaje automático capaz de identificar patrones asociados a lesiones sospechosas y generar un nivel de sospecha como apoyo al personal de salud.

La propuesta está orientada a facilitar la evaluación inicial y la priorización de casos que requieran una valoración dermatológica, especialmente en contextos donde el acceso a especialistas puede ser limitado. Asimismo, se contempla el registro de las imágenes y de la información del paciente mediante una aplicación móvil, con la finalidad de favorecer el seguimiento de las lesiones a lo largo del tiempo.

El sistema no pretende reemplazar la evaluación de un dermatólogo ni emitir un diagnóstico médico definitivo. Su finalidad es brindar una herramienta tecnológica de apoyo que contribuya a la identificación preliminar de lesiones sospechosas y facilite su referencia para una evaluación especializada.

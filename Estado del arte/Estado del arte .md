...
3. **Tecnologías y metodologías utilizadas:**  
   ...
   **Aprendizaje automático**  
   Los modelos de aprendizaje automático y deep learning permiten analizar imágenes y clasificarlas según características asociadas a lesiones benignas o malignas. Un metaanálisis de 27 estudios encontró una sensibilidad agrupada del 82 %, especificidad del 87 % y AUC de 0.92 para modelos de deep learning aplicados a imágenes dermatoscopias \[13\].
...
4. **Resultados principales:**  
   ...
   Finalmente, los modelos de deep learning han mostrado un alto potencial para la clasificación automática de lesiones, aunque todavía requieren validación clínica y datasets más diversas \[13\].  
...
- \[13\] Z. Ye et al., “Deep learning algorithms for melanoma detection using dermoscopic images: A systematic review and meta-analysis,” Artif. Intell. Med., vol. 155, p. 102934, 2024, doi: [10.1016/j.artmed.2024.102934](https://doi.org/10.1016/j.artmed.2024.102934)  
  ...
  La propuesta propone el uso de la termografía activa para evaluar la respuesta térmica dinámica de la piel mediante un estímulo térmico controlado, lo que permitiría validar clínicamente la detección de la vascularización y el metabolismo tumoral alterado al superar las limitaciones de la captura pasiva, utilizando el diferencial de temperatura entre la lesión y la piel sana como un indicador fisiológico cuantitativo clave para la evaluación.  
    
  *F. Malheiros, E. R. Silva, P. N. Fagundes, J. J. R. Faria, R. D. V. Leite, I. Guerra, V. d. A. Tanaka, B. A. Alvares, and V. d. L. Vazquez, "Active versus passive infrared thermography for skin cancer detection: A diagnostic accuracy study," \*Cancers\*, vol. 18, no. 5, p. 829, 2026, doi: 10.3390/cancers18050829. Disponible en: [https://www.mdpi.com/2072-6694/18/5/829](https://www.mdpi.com/2072-6694/18/5/829)*  
    
    
  Esta elevación de temperatura responde a los fundamentos biológicos del melanoma, caracterizado por un mayor consumo energético y por la formación de nuevos vasos sanguíneos (angiogénesis), aprovechando que la piel emite radiación de forma casi ideal para respaldar científicamente el uso del canal térmico y fundamentar la selección de un sensor infrarrojo de calidad médica para el prototipo.  
    
  *J. Verstockt, S. Verspeek, F. Thiessen, W. A. Tjalma, L. Brochez, and G. Steenackers, "Skin cancer detection using infrared thermography: Measurement setup, procedure and equipment," \*Sensors\*, vol. 22, no. 9, p. 3327, Apr. 2022, doi: 10.3390/s22093327. Disponible en: \[https://pmc.ncbi.nlm.nih.gov/articles/PMC9100961/\](https://pmc.ncbi.nlm.nih.gov/articles/PMC9100961/)*  
    
  Para complementar la firma térmica con evidencia de la estructura interna del tejido, el sistema podría integrar la modalidad de infrarrojo cercano, la cual penetra las capas profundas de la piel para revelar la distribución de componentes como la melanina y la hemoglobina, aportando una base óptica sólida que ayuda a diferenciar lunares benignos de lesiones sospechosas.  
    
  *M.-A. Ilișanu, F. Moldoveanu, and A. Moldoveanu, "Multispectral imaging for skin diseases assessment—State of the art and perspectives," \*Sensors\*, vol. 23, no. 8, p. 3888, Apr. 2023, doi: 10.3390/s23083888. Disponible en: \[https://www.mdpi.com/1424-8220/23/8/3888\](https://www.mdpi.com/1424-8220/23/8/3888)*
